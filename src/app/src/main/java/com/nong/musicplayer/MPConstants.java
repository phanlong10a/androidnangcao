...
public class MPConstants {
    public static final String PACKAGE_NAME = "com.nong.musicplayerlite";
    ...
    public static final String MEDIA_SESSION_TAG = "com.nong.musicplayerlite.MediaSession";

    public static final int NOTIFICATION_ID = 101;
    public static final String PLAY_PAUSE_ACTION = "com.nong.musicplayerlite.PLAYPAUSE";
    public static final String NEXT_ACTION = "com.nong.musicplayerlite.NEXT";
    public static final String PREV_ACTION = "com.nong.musicplayerlite.PREV";
    public static final String CLOSE_ACTION = "com.nong.musicplayerlite.CLOSE";
    public static final String CHANNEL_ID = "com.nong.musicplayerlite.CHANNEL_ID";
