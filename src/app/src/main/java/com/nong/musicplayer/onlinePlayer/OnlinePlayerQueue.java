...
public class OnlinePlayerQueue {
    private final Random random = new Random();
    private List<OnlineSong> currentQueue;
    ...
    public List<OnlineSong> getCurrentQueue() {
        return currentQueue;
    }

    public void setCurrentQueue(List<OnlineSong> currentQueue) {
    ...
    public void addMusicListToQueue(List<OnlineSong> music) {
