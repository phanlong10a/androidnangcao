...
public class OnlinePlayerService extends Service {
    ...
    public OnlinePlayerNotificationManager getNotificationManager() {
    ...
    private void configureMediaSession() {
        ...
        ComponentName mediaButtonReceiverComponentName = new ComponentName(this, OnlinePlayerManager.NotificationReceiver.class);
    ...
    public IBinder onBind(Intent intent) {
        if (playerManager == null) {
            playerManager = new OnlinePlayerManager(this);
            notificationManager = new OnlinePlayerNotificationManager(this);
    ...
    class LocalBinder extends Binder {
        public OnlinePlayerService getInstance() {
